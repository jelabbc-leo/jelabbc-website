<%@ Page Title="Gestión de Roles" Language="vb" MasterPageFile="~/MasterPages/Jela.Master" AutoEventWireup="false" CodeBehind="Roles.aspx.vb" Inherits="JelaWeb.Roles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxGridView ID="gridRoles" runat="server" ClientInstanceName="gridRoles"
        ...
        OnDataBound="gridRoles_DataBound">
        ...
        <SettingsText ConfirmDelete="¿Está seguro que desea eliminar este rol?" />
        
        <SettingsCommandButton>
            <NewButton Text="Nuevo Rol">
                <Image IconID="actions_add_16x16" />
            </NewButton>
            <EditButton Text="Editar Rol">
                <Image IconID="edit_edit_16x16" />
            </EditButton>
            <DeleteButton Text="Eliminar Rol">
        ...
        <Columns>
            ...
            <dx:GridViewDataCheckColumn FieldName="Activo" Caption="Activo" VisibleIndex="3" Width="80px" />
        </Columns>
        
        <EditFormLayoutProperties>
            <Items>
                <dx:GridViewLayoutGroup Caption="Datos del Rol" ColCount="1">
                    <Items>
